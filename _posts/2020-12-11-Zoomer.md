...
<img src="https://x-ry.github.io/assets/images/posts/DTC1/prototypeslap.png" alt="Zoomer Tablet" title="image_tooltip">
</div>
...
function animationFrame() {
  ...
  document.getElementById('image').style.backgroundPosition = "0px " + (35392 - 316 * (px+1)) + "px";
}
